<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-info.html";i:1498837264;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>原创创作平台</title>
    <link rel="stylesheet" type="text/css" href="/static/writer/css/index-21-i.css">
    <link rel="stylesheet" type="text/css" href="/static/writer/css/UBXCMkzNVlaZYNs-i.css">
...
<div id="root">
    <div data-reactroot="" class="framePage">
        <div class="content-wrap">

            <!-- 头部 -->
            <header class="topbar"><h1 class="topbar-logo"><img src=""></h1><!-- react-empty: 118 -->
            ...
            <div class="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-tab"><a class="" href="<?php echo url('index/writerinfo'); ?>"><h3><i
            ...
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <div class="content" id="c-input">
                        <div class="content-list position-fix">
                            <div class="page-title"><h2><span class="clor2">作者</span></h2></div>
                            <div class="hp-content-zuopinrongyu-base">
                                <div class="hp-content-left">
                                    <div>
                                        <div class="hp-content-left-title-b"
                                             style="opacity: 1; visibility: visible; transform: translateX(0px);">作者基础信息
                                            <span style="margin: 1px 90px "><a href="<?php echo url('index/modpwd'); ?>" style="color: red">修改密码</a></span>
                                        </div>
                                        <!--表单提交-->
                                        <form action="<?php echo url('index/infomod'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="hp-base-info"
                                             style="opacity: 1; visibility: visible; transform: translateX(0px);">
                                            <div class="hp-base-info-left">
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">当前笔名：<input type="text" class="inputcss"   name="wname" value="<?php echo $wname; ?>" ></p>
                                                </div>
                                                <!--<div class="hp-content-left-info-base"><p-->
                                                        <!--class="hp-content-left-info-class">待审核笔名：<input type="text" class="inputcss" placeholder="" name="dshname"></p>-->
                                                <!--</div>-->
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">身份证号：<input type="text" class="inputcss" value="<?php echo $idnumber; ?>" name="idnumber"></p>
                                                    <p class="hp-content-left-info-context-base"></p></div>
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">真实姓名：<input type="text" class="inputcss" value="<?php echo $name; ?>" name="name"></p>
                                                </div>
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">手机号：<input type="text" class="inputcss" value="<?php echo $tel; ?>" name="tel"></p>
                                                </div>
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">写作倾向：<input type="text" class="inputcss" value="<?php echo $inclination; ?>" name="inclination"></p>
                                                </div>
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">QQ号：<input type="text" class="inputcss" value="<?php echo $qq; ?>" name="qq"></p>
                                                </div>
                                            </div>
                                            <div class="hp-base-info-middle">
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">性别：<label ><input type="radio" class="inputcss"  name="sex" value="1" <?php echo !empty($sex) && $sex==1?'checked':''; ?>>男</label>
    <label ><input type="radio" class="inputcss"  name="sex" value="2" <?php echo !empty($sex) && $sex==2?'checked':''; ?>>女</label>
    <label ><input type="radio" class="inputcss"  name="sex" value="3" <?php echo !empty($sex) && $sex==3?'checked':''; ?>>保密</label>
                                                </p>
                                                </div>
                                                <div class="hp-content-left-info-base"><p
                                                        class="hp-content-left-info-class">邮箱：<input type="text" class="inputcss" value="<?php echo $email; ?>" name="email"></p>
                                                    <div class="hp-content-left-info-base"><p class="hp-content-left-info-class">状态：<span class="blue"><?php echo !empty($status) && $status==1?'激活':禁用; ?></span></p>
                                            </div>
                                                    <div class="hp-content-left-info-base"><p class="hp-content-left-info-class">等级：<span class="blue"><?php echo !empty($level) && $level==1?'普通写手':$level==2?'黄金写手':'白金写手'; ?></span></p>
                                        </div>
                                   <div class="file">
                                       <span class="blue">个性头像:</span>
                                       <img src="<?php echo $icon; ?>" class="fileimg">
                                       <input type="file" name="image">
                                   </div>
                                            <button type="submit" class="xg inputcss">确认修改</button>
                                    </div>
                                        </form>
                                    </div>
                            </div>
