<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp\www\tp5\public/../application/admin\view\chapter\index2.html";i:1498968959;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <meta charset="UTF-8">
    ...
    <div class="row mt50">
        <div class="col-md-12">
            <table class="table table-hover bg-info">
                ...
                <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $k = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    ...
                    <td class='price' data-price="<?php echo $v['price']; ?>" priceid="<?php echo $v['id']; ?>" k="<?php echo $k; ?>">
                        <span class="<?php echo $k; ?>"><?php echo $v['price']; ?></span>
                    ...
                    <td class="<?php echo $v['id']; ?>">
                        <?php switch($v['check']): case "0": ?><button class="btn btn-check btn-default btn-xs" checkid="<?php echo $v['id']; ?>">未审核</button><?php break; case "1": ?>审核未通过<?php break; case "2": ?>审核通过<?php break; endswitch; ?>
                    </td>
                    <td>
