<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-data.html";i:1498837232;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="content-wrap">
            ...
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <table style="font-size: 18px;width: 1500px;text-align: center">
                        ...
                        <tr >
                            ...
                            <td>
                                <a href="<?php echo url('index/writeradd',['name'=>$k['name']]); ?>">添加章节</a>
                                <a href="">评论区</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
