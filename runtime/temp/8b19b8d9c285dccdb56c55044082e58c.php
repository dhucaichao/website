<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-news.html";i:1498841368;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="content-wrap">
            ...
            <div class="content-page">
                ...
                <table style="width: 1200px;text-align: center">
                    <tr style="font-size: 22px;background-color: rgb(220,246,246);">
                        <th style="height: 50px;">用户名</th>
                        <th>小说名</th>
                        <th>评论内容</th>
                        <th>评论时间</th>
                        <th>操作</th>
                    ...
                    <tr style="font-size: 20px;height: 60px;">
                        <td><?php echo $k['uid']; ?></td>
                        <td><?php echo $k['nid']; ?></td>
                        <td><?php echo $k['content']; ?></td>
                        <td><?php echo $k['time']; ?></td>
                        <td>
                            <button style="width: 50px;height: 40px;background-color: rgb(220,246,246);color: #0f0f0f">回复</button>
                            <button style="width: 50px;height: 40px;background-color: rgb(220,246,246);color: #0f0f0f" class="del" del-id="<?php echo $k['id']; ?>">删除</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
...
<script>
    ...
    //执行删除
    function del(delid,obj) {
        $.ajax({
            type:'get',
            url:'/writer/index/writerdel?id=' + delid,
            datetype:'json',
