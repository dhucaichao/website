<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-checkout.html";i:1499099014;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <div style="color: #0f0f0f;font-size: 25px;margin: 80px 122px">
                        <p style="margin: 40px 0px">总月票:    <span style="color: red"class="ticket"><?php echo $sum; ?></span></p>
                        ...
                        <p style="margin: 40px 0px"><a href="<?php echo url('index/finance'); ?>">充值</a></p>
                    </div>
