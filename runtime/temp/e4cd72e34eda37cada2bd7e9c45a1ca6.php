<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wamp\www\tp5\public/../application/home\view\personal\safe.html";i:1499116186;}*/ ?>
<!doctype html>
<html lang="cn">
<head>
    <meta charset="UTF-8">
        ...
        <div class="substance">
            ...
            <div class="subright">
                ...
                <div class='row  clearfix'>
                    ...
                    <div class='row-title'>
                        基本资料
                        <span><a href="<?php echo url('personal/modpwd'); ?>" style="margin: 0px 40px">修改密码</a></span>
                    </div>

                </div>
                <form action="<?php echo url('personal/mod'); ?>" method='post' enctype="multipart/form-data">
                    <table>
                        <tr>
                            <td class='td-right'>昵称:</td>
                            <td class='td-left'><input type='text' class='text-box' name='nickname' value="<?php echo $list['nickname']; ?>"></td>
                        </tr>

                        <tr>
                            <td class='td-right'>手机号:</td>
                            <td class='td-left'> <input type='Tel' class='text-box' name='tel' value="<?php echo $list['tel']; ?>"> </td>
                        </tr>
                        
                        <tr>
                            <td class='td-right'>邮箱:</td>
                            <td class='td-left'><input type='email' class='text-box' name='email' value="<?php echo $list['email']; ?>"></td>
                        </tr>

                        <tr>
                            <td class='td-right'>您的性别:</td>
                            <td class='td-left radio-box'>
                                <label><input type='radio' value='1' name='sex' <?php echo !empty($list['sex']) && $list['sex']==1?'checked':''; ?>> 男&nbsp;&nbsp;</label>
                                <label><input type='radio' value="2" name='sex' <?php echo !empty($list['sex']) && $list['sex']==2?'checked':''; ?>> 女</label>
                            </td>
                        </tr>
                        <tr>
                            <td class='td-right'>当前头像:</td>
                            <td class='td-left'>
                                <img src="<?php echo $list['icon']; ?>" alt=" " style="width: 50px;"/>
