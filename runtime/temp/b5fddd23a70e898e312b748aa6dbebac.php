<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\wamp\www\tp5\public/../application/writer\view\index\writer-login.html";i:1499107149;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="wrapper">
            <div class="loginwrap">
                <div>
                    ...
                    <div style="color: rgb(55,186,245);font-size: 18px"><?php echo $txapi['0']['content']; ?></div>
                </div>
            </div>
