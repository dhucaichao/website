<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-add.html";i:1498721066;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="content-wrap">
            ...
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <!---->
                    <!-- 可替换主题部分 -->
                    <form action="<?php echo url('index/writeraddyz'); ?>" method="post">
                    <ul>
                        <li class="shum">
                            书名: <input type="text" value="<?php echo $name; ?>" class="name" name="penname">
                        </li>
                        <li class="shum">
                            已有章节: 第<input type="text" value="<?php echo $num; ?>" class="name" name="tnum" style="width: 60px;text-align: center" readonly>章 (<input type="text" value="<?php echo $title; ?>" name="title" readonly style="color: #0C82D9;text-align: center">)
                        </li>
                        <li class="shum">
                            新增章节名: <input type="text" class="zhangjie" name="newtitle">
                        </li>
                        <li >
                            正文:<textarea name="content" class='inputys zhengwen' rows='50'
                                      cols='200'></textarea>
                        </li>
                        <li>
                            <button type="submit" class = "shum tijiao">确定</button>
                        </li>
                    </ul>
                    </form>
                    <!--可替换结束-->
