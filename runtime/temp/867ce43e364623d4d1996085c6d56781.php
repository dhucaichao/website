<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp\www\tp5\public/../application/admin\view\category\index.html";i:1498568189;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <meta charset="UTF-8">
        ...
        <div class="col-md-12">
            <table class="table table-hover bg-info">
                ...
                <tr>
                    ...
                    <td>
                        <?php switch($v['display']): case "1": ?>显示<?php break; case "2": ?>隐藏<?php break; endswitch; ?>
                    </td>
                    <td class="col-md-4">
                        <a href="<?php echo url('category/edit',['id'=>$v['id']]); ?>" class="btn btn-primary btn-xs">编辑</a>
                        <a href="<?php echo url('category/index2',['id'=>$v['id']]); ?>" class="btn btn-primary btn-xs">子分类</a>
