<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-modpwd.html";i:1498618990;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="content-wrap">
            ...
            <div class="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-tab"><a class="" href="<?php echo url('index/writerinfo'); ?>"><h3><i class="anticon anticon-user"></i>
                        作者信息</h3></a></li>
                    <li class="nav-tab"><a class="" href=""><h3><i class="anticon anticon-tablet"></i>
                        作品数据</h3></a></li>
                    <li class="nav-tab"><h3><i class="anticon anticon-short"></i>消息管理
                    </h3>

                    <li class="nav-tab"><a class="" href=""><h3><i class="anticon anticon-money"></i>
                        结算中心</h3></a></li>
                </ul>
            </div>
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <!---->
                    <!-- 可替换主题部分 -->
                    <form action="<?php echo url('index/writermodpwd'); ?>" method="post">
                        <p style="font-size: 25px;margin:40px 100px">原密码:<input type="text" name="ypwd" style="border: 1px solid rgb(111,111,111);margin:1px 55px"></p>
                        <p style="font-size: 25px;margin:40px 100px">新密码:<input type="password" name="xpwd" style="border: 1px solid rgb(111,111,111);margin:1px 55px"></p>
                        <p style="font-size: 25px;margin:40px 100px">确认新密码:<input type="password" name="qrxpwd" style="border: 1px solid rgb(111,111,111);margin:1px 5px"></p>
                        <button type="submit" style="font-size: 25px;margin:40px 100px;background-color: rgb(241,90,36);width: 100px;height: 50px;color: #0f0f0f">确定</button>
                    </form>
                    <p style="font-size: 25px;margin:40px 100px;color: red"><?php echo $error; ?></p>
