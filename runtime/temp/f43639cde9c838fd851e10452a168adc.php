<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\wamp\www\newicefire\tp5\public/../application/writer\view\index\writer-details.html";i:1498721074;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="content-wrap">
            ...
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <!---->
                    <!-- 可替换主题部分 -->
                    <table style="border: 1px solid rgb(111,111,111)" class="table">
                        <tr >
                            <th>作品名称</th>
                            <th>章节数</th>
                            <th>最新章节名</th>
                        ...
                        <tr>
                            ...
                            <td><?php echo $categorty; ?></td>
                            <td><?php echo $isover; ?></td>
                            <td><?php echo $desc; ?></td>
                            <td>
                                <img src="<?php echo $face; ?>" style="width: 50px">
                            </td>
                            <td>
                                <a href="<?php echo url('index/writeradd',['name'=>$name]); ?>">添加章节</a>
                            </td>
                        </tr>
                    </table>
