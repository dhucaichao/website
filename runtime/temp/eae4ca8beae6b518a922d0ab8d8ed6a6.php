<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\wamp\www\tp5\public/../application/writer\view\index\writer-found.html";i:1498843985;}*/ ?>
<!DOCTYPE html>
                          ...
                          <!--<form action="<?php echo url('index/foundverify'); ?>" method="post" enctype="multipart/form-data"></form>-->
                                        ...
                                        <div class='zuopin'>作品分类:
                                            <p>
                                                ...
                                                <label><input type="radio" class='zpfl' name='zpfl' checked value="3">言情</label>
                                                <label><input type="radio" class='zpfl' name='zpfl'
                                                              value="4">穿越</label>
                                                <label><input type="radio" class='zpfl' name='zpfl'
                                                              value="5">架空</label>
                                                <label><input type="radio" class='zpfl' name='zpfl'
                                        ...
                                        <div class="submit-div-btn">
                                            <input type="submit" class="foot-btn-submit"
                                                   value="提交审核">
                                        </div>

                                    </div>
                                    <div class="cb-footer"></div><!-- react-empty: 245 --></div>
                            </form>
