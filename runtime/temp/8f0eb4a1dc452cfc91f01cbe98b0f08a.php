<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\wamp\www\tp5\public/../application/writer\view\index\author-money.html";i:1498837142;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="content-page">
                <div class="createbookPage">
                    ...
                    <div style="font-size: 20px">
                        <p style="margin: 20px 40px">当前头衔: <span style="color: red;margin: 0px 40px;"><?php echo !empty($level) && $level==1?'普通写手':$level==2?'黄金写手':白金写手; ?></span></p>
                        <p style="margin: 20px 40px">当前排名: <span style="color: red;margin: 0px 40px;"><?php echo $rank; ?></span></p>
                        <p style="margin: 20px 40px">总月票: <span style="color: red;margin: 0px 40px;"><?php echo $Tcollect; ?></span></p>
                        <p style="margin: 20px 40px">总积分: <span style="color: red;margin: 0px 40px;"><?php echo $integral; ?></span></p>
                        <p style="margin: 20px 40px">账户余额: <span style="color: red;margin: 0px 40px;"><?php echo $balance; ?></span></p>
                    </div>
                    <div style="font-size: 24px;margin: 50px 40px;color: #0f0f0f;">
                        <a href="<?php echo url('index/writercheckout'); ?>" >结算</a>
                        <a href="" style="margin: 0px 45px;">充值</a>
                    </div>
