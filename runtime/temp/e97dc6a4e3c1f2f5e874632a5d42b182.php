<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wamp\www\tp5\public/../application/admin\view\banner\index.html";i:1498738653;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <meta charset="UTF-8">
        ...
        <div class="col-md-12">
            <table class="table table-hover bg-info">
                ...
                <tr>
                    ...
                    <td class="col-md-4">
                        <a href="<?php echo url('banner/edit',['id'=>$v['id']]); ?>" class="btn btn-primary btn-xs">更换</a>
